...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div style=\"text-align:center\">\n  <div>\n    <h5>Enter a number</h5>\n    <input type=\"number\" placeholder=\"ex: 12\" [(ngModel)]=\"topN\" />\n    <button type=\"button\" [disabled]=\"check()\" (click)=\"process()\">Submit</button>\n  </div>\n  <div *ngIf=\"visualData.length\">\n    <table>\n      <thead>\n        <tr>\n          <th>Word.....</th>\n          <th>Number Of Time Repeat</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor=\"let item of visualData\">\n          <td>{{item[0]}}</td>\n          <td>{{item[1]}}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n  <div *ngIf=\"!flg\">\n      <h1>All data are visible here. Don't have more than that</h1>\n  </div>\n</div>"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.process = function () {
        var _this = this;
        this._httpService.fetchFreqency(this.topN).subscribe(function (response) {
            _this.visualData = response.message;
            _this.flg = response.flg;
...
var HttpService = (function () {
    function HttpService(_http) {
        this._http = _http;
        this._url = 'http://api.biplab.cf';
    }
    HttpService.prototype.fetchFreqency = function (n) {
        return this._http.get(this._url + '/' + n + '/fetch_frequency')
